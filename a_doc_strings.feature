...
Feature: feature de prueba para card 3537
  ...
  Scenario: Usuario envía un mensaje multilínea
    ...
    And Este es un step definido en dos idiomas
    And This is a step defined in two languages
    And modificado se obtuvo el response esperado en PROJECTS con el rq_test.json
